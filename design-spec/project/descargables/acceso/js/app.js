...
class Component extends DCLogic {
  state = {
    view: 'auth', authView: 'login', regStep: 1,
  ...
  renderVals() {
    ...
    return {
      ...
      showApp: s.view === 'app',
      goLanding: (e) => { if (e && e.preventDefault) e.preventDefault(); window.location.href = 'home.html'; },
      ...
      openAuth: (e) => { if (e && e.preventDefault) e.preventDefault(); this.setState({ view: 'auth', authView: 'login', error: '' }); },
